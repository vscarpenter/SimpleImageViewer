...
- Keep the existing inspector and viewer design tokens. Show description first, optional Notable details, expandable Text in image and Suggested tags, visible specific limitations and an About this analysis disclosure, and native Analyze image/Copy description/Refresh/Cancel controls.
