...
Design approved2026-09-14. Execute continuously; no additional design or plan approval gate.
...
4. Complete Xcode-managed27.0/arm64 settings, remove obsolete OS branches, and require the matching SDK/runtime in CI.
